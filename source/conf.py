...
project = 'Open tools for large-scale spatial accessibility analysis in Python and R'
copyright = '2022, Henrikki Tenkanen (Aalto University) & r5py/r5r contributors.'
author = 'Henrikki Tenkanen & r5py/r5r contributors.'
...
html_theme_options = {
    # "external_links": [],
    "repository_url": "https://github.com/r5py/r5edu/",
